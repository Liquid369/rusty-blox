...
const GROUPS = [
  {
    ...
    endpoints: [
      ...
      { m: '404', p: 'not served', d: 'feestats, block-filters, contract/rpcCall (EVM-only), tickers ?block, address filter=inputs|outputs, tx ?spending + spentTxId enrichment, xpub-descriptor /utxo. These return JSON 404 / unknown method.', ttl: '' },
    ],
  },
  {
    title: 'WEBSOCKET',
