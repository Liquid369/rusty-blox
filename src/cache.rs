...
impl CacheManager {
    ...
    pub fn with_capacities(
        ...
        Self {
            blocks_by_height: Arc::new(RwLock::new(LruCache::new(
                NonZeroUsize::new(blocks_by_height_cap).unwrap(),
            ))),
            blocks_by_hash: Arc::new(RwLock::new(LruCache::new(
                NonZeroUsize::new(blocks_by_hash_cap).unwrap(),
            ))),
            transactions: Arc::new(RwLock::new(LruCache::new(
                NonZeroUsize::new(transactions_cap).unwrap(),
            ))),
            addresses: Arc::new(RwLock::new(LruCache::new(
                NonZeroUsize::new(addresses_cap).unwrap(),
            ))),
