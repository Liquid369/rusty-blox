use crate::address_rollback::{build_address_undo_from_block, store_address_undo};
use rocksdb::DB;
...
pub async fn build_address_undo_for_range(
    ...
    info!(
        ...
        "Building address undo data for reorg protection"
    );
    ...
    info!(
        ...
        "Address undo data built; reorg protection enabled"
    );
